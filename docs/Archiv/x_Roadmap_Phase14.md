...
5. **Doku-Abgleich dieser Datei:** Kapitel 4-Index (Kapitel 4.1–4.5 archiviert in `x_Roadmap_Phase14.md`), Kapitel 5-Umsetzungsstatus, Kapitel 6/7.2/7.3 auf den Ist-Zustand aktualisiert.
...
- [x] **U15-C3** Legacy-Tabellen-Entscheidung dokumentiert (→ §3.3 unten):
  ...
  erhalten (kein DROP).
- [x] **U15-A3** `../AKTUELLE_UMSETZUNG.md` neu aufgesetzt (dieses Dokument
