...
* **Inhalte deckungsgleich:** Das Kapitel 19.01 in `../AKTUELLE_UMSETZUNG.md` ist
  **identisch** mit der uncommitteten Ergänzung in `x_Roadmap_Phase19.md`
...
* **Kein verwaister Legacy-Code:** Projektweite Suche nach `ema_diff`/`rsi_14`/
  ...
  `EMADiffFeature`/`ATRNormalizedFeature` (ohne `../../test`/`..`/`.venv`) → **0 Treffer**
  in Produktivdateien.
